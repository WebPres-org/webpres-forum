...
def plan(request):
    ...
    if request.method=="POST":
        ...
        post.save()
        alert = True
        return render(request, "plan.html", {'alert':alert})
    posts = Post.objects.filter().order_by('-timestamp')
    return render(request, "plan.html", {'posts':posts})
...
def terms(request):
    ...
    if request.method=="POST":
        ...
        post.save()
        alert = True
        return render(request, "terms.html", {'alert':alert})
    posts = Post.objects.filter().order_by('-timestamp')
    return render(request, "terms.html", {'posts':posts})
...
def privacy(request):
    ...
    if request.method=="POST":
        ...
        post.save()
        alert = True
        return render(request, "privacy.html", {'alert':alert})
    posts = Post.objects.filter().order_by('-timestamp')
    return render(request, "privacy.html", {'posts':posts})
